...
truvari refine -r temp/eichler_covered_spans.bed --use-original-vcfs --reference $REF -t 8 $OUTDIR/bench_ei
truvari refine -r temp/li_covered_spans.bed --use-original-vcfs --reference $REF -t 8 $OUTDIR/bench_li
truvari refine --use-original-vcfs --reference $REF -t 8 $OUTDIR/bench_al
wait
