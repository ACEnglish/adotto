# Select only single coverage from adotto and dipcall alignments of HPRC HG002
# also subsets the TRregions to those contained entirely within the regions
# Creates adotto hq regions, dipcall hq regions, and the combination of the two
